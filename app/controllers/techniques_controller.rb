class TechniquesController < ApplicationController
  ...
  # GET /techniques.json
  def index
    @techniques = Technique.all.paginate(:page => params[:page], :per_page => 30) 
  end
  ...
  private
    ...
    def technique_params
      params.require(:technique).permit(:name, :short_name, :price_icho, :price_ncc, :price_cc, :price_science)
    end
end
